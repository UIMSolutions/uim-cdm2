module uim.cdm.classes.object_base;

import uim.cdm;    
    
abstract class DCDMObjectBase : ICDMObject {
 ...
 */        // }
    ...
    mixin(TProperty!("int", "id"));
        mixin(TProperty!("ECDMObjectType", "objectType"));
        mixin(TProperty!("ICDMCorpusContext", "ctx"));

        /*
        /// <inheritdoc />
        abstract CdmObject Copy(ResolveOptions resOpt = null, CdmObject host = null);
        /// <inheritdoc />
        abstract bool Validate();
        /// <inheritdoc />
        abstract bool IsDerivedFrom(string baseDef, ResolveOptions resOpt = null);
        private IDictionary<string, ResolvedTraitSetBuilder> TraitCache { get; set; }
        */
        mixin(TProperty!("string", "declaredPath"));

        mixin(TProperty!("ICDMObject", "owner"));
        /*
        [Obsolete]
        abstract CdmObjectType GetObjectType();
        /// <inheritdoc />
        abstract string FetchObjectDefinitionName();
        /// <inheritdoc />
        abstract T FetchObjectDefinition(T)(ResolveOptions resOpt = null) where T : CdmObjectDefinition;
        protected bool resolvingAttributes = false;
        protected bool circularReference;
        /// <inheritdoc />
        virtual string AtCorpusPath
        {
            get
            {
        ...
        /// <inheritdoc />
        virtual CdmDocumentDefinition InDocument { get; set; }
        private virtual void ConstructResolvedTraits(ResolvedTraitSetBuilder rtsb, ResolveOptions resOpt) {
            return;
        }
        private virtual ResolvedAttributeSetBuilder ConstructResolvedAttributes(ResolveOptions resOpt, CdmAttributeContext under = null) {
            return null;
        }
        private bool resolvingTraits = false;
        private virtual ResolvedTraitSet FetchResolvedTraits(ResolveOptions resOpt = null) {
        ...
        virtual private ResolvedAttributeSetBuilder FetchObjectFromCache(ResolveOptions resOpt, AttributeContextParameters acpInContext = null) {
        ...
        private ResolvedAttributeSet FetchResolvedAttributes(ResolveOptions resOpt = null, AttributeContextParameters acpInContext = null) {
            bool wasPreviouslyResolving = this.Ctx.Corpus.isCurrentlyResolving;
            this.Ctx.Corpus.isCurrentlyResolving = true;
            if (resOpt == null) {
                resOpt = new ResolveOptions(this, this.Ctx.Corpus.DefaultResolutionDirectives);
        ...
        private void ClearTraitCache() {
            this.TraitCache = null;
        }
        [Obsolete("CopyData is deprecated. Please use the Persistence Layer instead.")]
        abstract dynamic CopyData(ResolveOptions resOpt = null, CopyOptions options = null);
        [Obsolete("InstanceFromData is deprecated. Please use the Persistence Layer instead.")]
        static dynamic InstanceFromData<T, U>(CdmCorpusContext ctx, U obj)
            where T : CdmObject
        {
        ...
        [Obsolete("CopyData is deprecated. Please use the Persistence Layer instead.")]
        static dynamic CopyData(T)(T instance, ResolveOptions resOpt = null, CopyOptions options = null)
             where T : CdmObject
        {
            if (resOpt == null) {
        ...
        private static CdmCollection(T) ListCopy(T)(ResolveOptions resOpt, CdmObject owner, CdmCollection(T) source) where T : CdmObject
        {
            if (source == null)
                return null;
        ...
        /// <inheritdoc />
        abstract bool Visit(string path, VisitCallback preChildren, VisitCallback postChildren);
        /**
        /// Calls the Visit function on all objects in the collection.
        * /
        private static bool VisitList(IEnumerable<dynamic> items, string path, VisitCallback preChildren, VisitCallback postChildren) {
            bool result = false;
            if (items != null) {
        ...
        private static CdmTraitReference ResolvedTraitToTraitRef(ResolveOptions resOpt, ResolvedTrait rt) {
        ...
        /// <inheritdoc />
        abstract CdmObjectReference CreateSimpleReference(ResolveOptions resOpt = null);
        private abstract CdmObjectReference CreatePortableReference(ResolveOptions resOpt);
    }
 */
}
