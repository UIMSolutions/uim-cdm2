module uim.cdm.classes.corpus_definition;

import uim.cdm;    

class DCDMCorpusDefinition {
        ...
        // The storage.
        mixin(TProperty!("StorageManager", "storage"));
        /**
        /// The persistence layer.
        * /
        PersistenceLayer Persistence { get; }

        // Gets the object context. */
        mixin(TProperty!("CdmCorpusContext", "ctx"));

        // Gets or sets the app ID, optional property.
        mixin(TProperty!("string", "appId"));
        ...
        private bool isCurrentlyResolving = false;

        /// Used by Visit functions of CdmObjects to skip calculating the declaredPath.
        private bool blockDeclaredPathChanges = false;
        ...
        AttributeResolutionDirectiveSet DefaultResolutionDirectives { get; set; }

/*
        private IDictionary<string, List<DCDMDocumentDefinition>> SymbolDefinitions { get; set; }
        private IDictionary<string, SymbolSet> DefinitionReferenceSymbols { get; set; }
        ...
        private CdmManifestDefinition rootManifest { get; set; }
        ...
        * /
        CdmCorpusDefinition() {
            this.SymbolDefinitions = new Dictionary<string, List<DCDMDocumentDefinition>>();
        ...
        async Task<CdmManifestDefinition> CreateRootManifestAsync(string corpusPath) {
        ...
        private ResolvedTraitSet CreateEmptyResolvedTraitSet(ResolveOptions resOpt) {
        ...
        private void RegisterSymbol(string symbol, DCDMDocumentDefinition inDoc) {
            this.SymbolDefinitions.TryGetValue(symbol, out List<DCDMDocumentDefinition> docs);
            if (docs == null) {
                docs = new List<DCDMDocumentDefinition>();
                this.SymbolDefinitions[symbol] = docs;
            }
            docs.Add(inDoc);
        }*/

        private void UnRegisterSymbol(string symbol, DCDMDocumentDefinition inDoc) {
/*             this.SymbolDefinitions.TryGetValue(symbol, out List<DCDMDocumentDefinition> docs);
            if (docs != null) {
 ...
 */     }
        ...
        private DocsResult DocsForSymbol(ResolveOptions resOpt, DCDMDocumentDefinition wrtDoc, DCDMDocumentDefinition fromDoc, string symbol) {
            ...
            this.SymbolDefinitions.TryGetValue(symbol, out List<DCDMDocumentDefinition> docList);
            ...
            if (result.DocList == null || result.DocList.Count == 0) {
                ...
                if (preEnd > 0) {
                    ...
                    this.SymbolDefinitions.TryGetValue(result.NewSymbol, out List<DCDMDocumentDefinition> tempDocList);
                    result.DocList = tempDocList;
                    DCDMDocumentDefinition tempMonikerDoc = null;
        ...
        private CdmObjectBase ResolveSymbolReference(ResolveOptions resOpt, DCDMDocumentDefinition fromDoc, string symbolDef, CdmObjectType expectedType, bool retry) {
            ResolveContext ctx = this.Ctx as ResolveContext;
            ...
            DCDMDocumentDefinition wrtDoc = resOpt.WrtDoc as DCDMDocumentDefinition;
            ...
            DCDMDocumentDefinition docBest = symbolDocsResult.DocBest;
            symbolDef = symbolDocsResult.NewSymbol;
            List<DCDMDocumentDefinition> docs = symbolDocsResult.DocList;
            if (docs != null) {
                ...
                IDictionary<DCDMDocumentDefinition, ImportInfo> importPriority = wrtDoc.ImportPriorities.ImportPriority;
        ...
        private void RegisterDefinitionReferenceSymbols(CdmObject definition, string kind, SymbolSet symbolRefSet) {
        ...
        private string CreateDefinitionCacheTag(ResolveOptions resOpt, CdmObjectBase definition, string kind, string extraTags = "", bool notKnownToHaveParameters = false, string pathToDef = null) {
            ...
            if (symbolsRef?.Size > 0) {
                ...
                DCDMDocumentDefinition wrtDoc = resOpt.WrtDoc;
                ...
                if (wrtDoc.ImportPriorities != null) {
                    foreach (string symRef in symbolsRef) {
                        ...
                        if (docsRes?.DocList?.Count > 1) {
                            DCDMDocumentDefinition docBest = FetchPriorityDocument(docsRes.DocList, wrtDoc.ImportPriorities.ImportPriority);
                            if (docBest != null) {
        ...
        * /
        T MakeRef(T)(CdmObjectType ofType, dynamic refObj, bool simpleNameRef) where T : CdmObjectReference
        {
        ...
        * /
        T MakeObject(T)(CdmObjectType ofType, string nameOrRef = null, bool simpleNameRef = false) where T : CdmObject
        {
            ...
            switch (ofType) {
                ...
                case CdmObjectType.DocumentDef:
                    newObj = new DCDMDocumentDefinition(this.Ctx, nameOrRef);
                    break;
        ...
        private static CdmObjectType MapReferenceType(CdmObjectType ofType) {
            switch (ofType) {
                case CdmObjectType.ArgumentDef:
                case CdmObjectType.DocumentDef:
                case CdmObjectType.ManifestDef:
        ...
        private static string CreateCacheKeyFromObject(CdmObject definition, string kind) {
            return definition.Id.ToString() + "-" + kind;
        }
        private static DCDMDocumentDefinition FetchPriorityDocument(List<DCDMDocumentDefinition> docs, IDictionary<DCDMDocumentDefinition, ImportInfo> importPriority) {
            DCDMDocumentDefinition docBest = null;
            int indexBest = int.MaxValue;
            foreach (DCDMDocumentDefinition docDefined in docs) {
        ...
        private DCDMDocumentDefinition AddDocumentObjects(CdmFolderDefinition folder, DCDMDocumentDefinition docDef) {
        ...
        private void RemoveDocumentObjects(CdmFolderDefinition folder, DCDMDocumentDefinition docDef) {
            DCDMDocumentDefinition doc = docDef as DCDMDocumentDefinition;
        ...
        private bool IndexDocuments(ResolveOptions resOpt, bool loadImports) {
            List<DCDMDocumentDefinition> docsNotIndexed = this.documentLibrary.ListDocsNotIndexed();
            if (docsNotIndexed.Count == 0) {
                return true;
            }
            // clear caches.
            foreach (DCDMDocumentDefinition doc in docsNotIndexed) {
        ...
        private async Task<CdmContainerDefinition> LoadFolderOrDocument(string objectPath, bool forceReload = false, ResolveOptions resOpt = null) {
            if (!string.IsNullOrWhiteSpace(objectPath)) {
                ...
                string module = !string.IsNullOrWhiteSpace(pathTuple.Item1) ? pathTuple.Item1 : this.Storage.DefaultNamespace;
                ...
                if (objectPath.StartsWith("/")) {
                    ...
                    if (namespaceFolder == null || namespaceAdapter == null) {
                        Logger.Error(nameof(CdmCorpusDefinition), this.Ctx, "The module '" + module + "' has not been registered", $"LoadFolderOrDocument({objectPath})");
                        return null;
                    }
        ...
        * /
        ...
        /// <param name="obj">Optional parameter. When provided, it is used to obtain the FolderPath and the module needed to create the absolute path from a relative path.</param>
        ...
        async Task(T) FetchObjectAsync(T)(string objectPath, CdmObject obj = null, ResolveOptions resOpt = null, bool forceReload = false)
            where T : CdmObject
        {
            if (resOpt == null) {
            ...
            if (newObj != null) {
                ...
                if (newObj is DCDMDocumentDefinition doc) {
                ...
                var result = ((DCDMDocumentDefinition)newObj).FetchObjectFromDocumentPath(remainingObjectPath, resOpt);
                if (result == null) {
        ...
        * /
        ...
        /// <param name="forceReload">Optional parameter. When true, the document containing the requested object is reloaded from storage to access any external changes made to the document since it may have been cached by the corpus.</param>
        /// <returns>The object obtained from the provided path.</returns>
        async Task(T) FetchObjectAsync(T)(string objectPath, CdmObject obj, bool shallowValidation, bool forceReload = false)
            where T : CdmObject
        {
        ...
        * /
        void SetEventCallback(EventCallback status, CdmStatusLevel reportAtLevel = CdmStatusLevel.Info) {
            ResolveContext ctx = this.Ctx as ResolveContext;
        ...
        * /
        private void FindMissingImportsFromDocument(DCDMDocumentDefinition doc) {
            if (doc.Imports != null) {
        ...
        * /
        private void SetImportDocuments(DCDMDocumentDefinition doc) {
            if (doc.Imports != null) {
                foreach (var imp in doc.Imports) {
                    if (imp.Document == null) {
                        // no document set for this import, see if it is already loaded into the corpus
        ...
        /// 
        * /
        private async Task LoadImportsAsync(DCDMDocumentDefinition doc, ResolveOptions resOpt) {
            var docsNowLoaded = new ConcurrentDictionary<DCDMDocumentDefinition, byte>();
            ...
            async Task loadDocs(string missing) {
                if (this.documentLibrary.NeedToLoadDocument(missing, docsNowLoaded)) {
                    ...
                    // load it
                    var newDoc = await this.LoadFolderOrDocument(missing, false, resOpt) as DCDMDocumentDefinition;
        ...
        * /
        private async Task ResolveImportsAsync(DCDMDocumentDefinition doc, ResolveOptions resOpt) {
        ...
        private bool CheckObjectIntegrity(DCDMDocumentDefinition CurrentDoc) {
            ResolveContext ctx = this.Ctx as ResolveContext;
            var errorCount = 0;
        ...
        private void DeclareObjectDefinitions(DCDMDocumentDefinition CurrentDoc, string relativePath) {
            ResolveContext ctx = this.Ctx as ResolveContext;
        ...
        private void RemoveObjectDefinitions(DCDMDocumentDefinition doc) {
            ResolveContext ctx = this.Ctx as ResolveContext;
        ...
        private dynamic ConstTypeCheck(ResolveOptions resOpt, DCDMDocumentDefinition CurrentDoc, CdmParameterDefinition paramDef, dynamic aValue) {
            ResolveContext ctx = this.Ctx as ResolveContext;
        ...
        private void ResolveObjectDefinitions(ResolveOptions resOpt, DCDMDocumentDefinition CurrentDoc) {
            ResolveContext ctx = this.Ctx as ResolveContext;
        ...
        private void ResolveTraitArguments(ResolveOptions resOpt, DCDMDocumentDefinition CurrentDoc) {
            ResolveContext ctx = this.Ctx as ResolveContext;
            CurrentDoc.Visit(string.Empty, new VisitCallback
            {
                Invoke = (iObject, path) =>
        ...
        private void FinishDocumentResolve(DCDMDocumentDefinition doc, bool importsLoaded) {
        ...
        private void FinishResolve() {
            ...
            List<DCDMDocumentDefinition> AllDocuments = this.documentLibrary.ListAllDocuments();
        ...
        List<CdmE2ERelationship> FetchIncomingRelationships(CdmEntityDefinition entity) {
        ...
        /// <param name="entity"> The entity that we want to get relationships for.</param>
        List<CdmE2ERelationship> FetchOutgoingRelationships(CdmEntityDefinition entity) {
        ...
        * /
        ...
        async Task CalculateEntityGraphAsync(CdmManifestDefinition currManifest) {
        ...
        private List<CdmE2ERelationship> FindOutgoingRelationships(
        ...
        * /
        ...
        private List<CdmE2ERelationship> FindOutgoingRelationshipsForProjection(
        ...
        * /
        ...
        private List<CdmE2ERelationship> FindOutgoingRelationshipsForEntityRef(
        ...
        * /
        private async Task<DateTimeOffset?> ComputeLastModifiedTimeAsync(string corpusPath, CdmObject obj = null) {
        ...
        * /
        private async Task<DateTimeOffset?> GetLastModifiedTimeAsyncFromObject(CdmObject currObject) {
        ...
        * /
        private async Task<DateTimeOffset?> GetLastModifiedTimeAsyncFromPartitionPath(string corpusPath) {
        ...
        * /
        ...
        async Task<CdmValidationStep> ResolveReferencesAndValidateAsync(CdmValidationStep stage, CdmValidationStep stageThrough, ResolveOptions resOpt) {
            ...
            foreach (DCDMDocumentDefinition doc in this.documentLibrary.ListAllDocuments()) {
            ...
            switch (stage) {
                ...
                case CdmValidationStep.TraitAppliers:
                    return this.ResolveReferencesStep(
                        "defining traits...",
                        (ref DCDMDocumentDefinition currentDoc, ref ResolveOptions resOptions, ref int entityNesting) =>
                        {
                        },
        ...
        private delegate void ResolveAction(ref DCDMDocumentDefinition currentDoc, ref ResolveOptions resOptions, ref int entityNesting);
        private CdmValidationStep ResolveReferencesStep(
            ...
            foreach (DCDMDocumentDefinition doc in this.documentLibrary.ListAllDocuments()) {
                ...
                DCDMDocumentDefinition CurrentDoc = doc;
        ...
        private void ResolveForeignKeyReferences(
            ref DCDMDocumentDefinition currentDoc,
            ResolveOptions resOpt,
        ...
        private void ResolveAttributes(ref DCDMDocumentDefinition currentDoc, ResolveOptions resOpt, ref int entityNesting) {
            var ctx = this.Ctx as ResolveContext;
            var nesting = entityNesting;
            currentDoc.Visit("",
                new VisitCallback
        ...
        private void ResolveReferencesTraitsArguments(
            ...
            ResolveOptions resOpt,
            ref int entityNesting) {
            DCDMDocumentDefinition CurrentDoc = currentDoc; // not clear why the currentDoc is ref. anyone?
            var ctx = this.Ctx as ResolveContext;
        ...
        private void ResolveTraits(ref DCDMDocumentDefinition currentDoc, ResolveOptions resOpt, ref int entityNesting) {
        ...
        * /
        ...
        private async Task GenerateWarningsForSingleDoc(Tuple<CdmFolderDefinition, DCDMDocumentDefinition> fd, ResolveOptions resOpt) {
            var doc = fd.Item2;
        ...
        * /
        /// <returns></returns>
        private async Task<bool> PrepareArtifactAttributesAsync() {
        ...
        * /
        ...
        /// <returns></returns>
        private CdmTypeAttributeDefinition FetchArtifactAttribute(string name) {
            if (this.KnownArtifactAttributes == null)
